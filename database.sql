-- Active: 1687991172719@@127.0.0.1@3306
...
VALUES
    -- senha = fulano123 (
        ...
        'Fulano',
        'fulano@email.com',
        '$2a$12$IsYkYIDtNZuhG2MGg31JI.Pk20a5QkFmLZWYIHPi2B3SqT5AquU9m',
        'NORMAL'
    ),
    -- senha = beltrana00 (
        'u002',
        'Beltrana',
        'beltrana@email.com',
        '$2a$12$0X0k8Of3s7w4aKmVA8myS.UaxJOyZq5p9K9CIeQMej5hyU6j7V2.W',
        'NORMAL'
    ),
    -- senha = astrodev99 (
        'u003',
        'Astrodev',
        'astrodev@email.com',
        '$2a$12$zOChEK2fGYiPafZNomVeI.K3W4QHcCP13iv./5aU/ERKkhwA4Z/GC',
        'ADMIN'
    );
